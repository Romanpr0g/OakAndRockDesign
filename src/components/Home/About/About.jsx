        ...
        <div className="container">
          <div className={s.features}>
            <div className={s.card}>
              <div className={s.icon}><img src={about1} className={s.icon__img} alt="" /></div>
              <h3>Полный контроль цепочки</h3>
              <p>Минимум рисков, конкурентные цены.</p>
            </div>
            <div className={s.card}>
              <div className={s.icon}><img src={about2} className={s.icon__img} alt="" /></div>
              <h3>Европейские стандарты</h3>
              <p>Мы сочетаем европейское качество с локальной гибкостью.</p>
            </div>
            <div className={s.card}>
              <div className={s.icon}><img src={about3} className={s.icon__img} alt="" /></div>
